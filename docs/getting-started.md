...
- The gate & circuit oriented Idris DSL intermediate IR representation provides additional support for Lean verification of unitary fragments of quantum code.  
